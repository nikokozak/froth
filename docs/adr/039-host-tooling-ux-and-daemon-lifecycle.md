...
**Date**: 2026-03-17
**Status**: Accepted
**Spec sections**: ADR-035 (daemon architecture), ADR-037 (host-centric deployment), docs/concepts/vscode-extension-design.md
...
- docs/concepts/vscode-extension-design.md: full extension vision, two modes, workshop scope
- docs/concepts/host-tooling-roadmap.md: phased plan
