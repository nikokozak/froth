...
// Matches Go daemon: filepath.Join(home, ".froth", "daemon.sock")
const DEFAULT_SOCKET_PATH = path.join(os.homedir(), ".froth", "daemon.sock");
...
export class DaemonClient {
  ...
  connect(socketPath: string = DEFAULT_SOCKET_PATH): Promise<void> {
    if (this.disposed) {
